...
QT_MOC_LITERAL(6, 47, 17), // "voiceCallReceived"
QT_MOC_LITERAL(7, 65, 8), // "callData"
QT_MOC_LITERAL(8, 74, 14), // "onDataReceived"
QT_MOC_LITERAL(9, 89, 14), // "onLoginClicked"
QT_MOC_LITERAL(10, 104, 14), // "onStateChanged"
...
QT_MOC_LITERAL(12, 148, 5) // "state"
    ...
    "closed\0voiceCallReceived\0callData\0"
    "onDataReceived\0onLoginClicked\0"
...
void SecondWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->voiceCallReceived((*reinterpret_cast< const QJsonObject(*)>(_a[1]))); break;
        case 3: _t->onDataReceived(); break;
        case 4: _t->onLoginClicked(); break;
        case 5: _t->onStateChanged((*reinterpret_cast< QAbstractSocket::SocketState(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (SecondWindow::*)(const QJsonObject & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SecondWindow::voiceCallReceived)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void SecondWindow::voiceCallReceived(const QJsonObject & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
